...
**Execution root:** Run all shell commands from the plugin root (`plugins/mixshift-ai/`). Command examples below assume that working directory and use `python scripts/...`.
