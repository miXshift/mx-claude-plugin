...
# line. A machine keeps every version it has ever installed, and text order is
# not version order (as text, 0.8.10 sorts before both 0.8.9 and 0.9.0).
# Set MIXSHIFT_CLI to the path you picked.
