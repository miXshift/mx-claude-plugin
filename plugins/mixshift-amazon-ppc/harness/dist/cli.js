...
function registerProfileCommands(program3) {
  ...
  profile.command("show").description("Print the current user profile").action(() => {
    notYetImplemented("profile show", {});
  });
  profile.command("set <key> <value>").description("Set a profile field (dot.path syntax for nested keys)").action((key, value) => {
